"""
Django settings for samtest_4 project.
...
WSGI_APPLICATION = 'samtest_4.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "samtest_4 API",
    "DESCRIPTION": "API documentation for samtest_4 App",
    "VERSION": "v1",
}
